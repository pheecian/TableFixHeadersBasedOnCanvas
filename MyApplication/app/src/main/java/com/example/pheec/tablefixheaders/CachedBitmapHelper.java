...
public class CachedBitmapHelper {
    ...
    private static class LazyHolder {
        private static final CachedBitmapHelper INSTANCE = new CachedBitmapHelper();
    }
